    ...
    >
      ...
      <div className="p-5">
        ...
        <Link
          to={path}
          className={`
            btn w-full text-xs ${isLive ? `${colors.solid}` : 'bg-white text-stone-900 border border-stone-900/5 cursor-default pointer-events-none opacity-60 dark:bg-bugbusters-card dark:border-white/10 dark:text-white'}
          `}
        >

...
export default function StepTable({ steps, current, onRowClick, columns }) {
  ...
  return (
    <section className="card overflow-hidden dark:bg-[#0f172a] dark:border-[rgba(255,255,255,0.06)]" aria-label="Step table">
              ...
              return (
                <tr
                  ...
                  className={`cursor-pointer border-b border-stone-900/5 transition-colors duration-100 dark:border-[rgba(255,255,255,0.04)]
                    ${isCurrent ? 'bg-amber-500/10 shadow-[inset_3px_0_0_0_#f43f5e] dark:bg-bugbusters-cyan/[0.06]' : ''}
